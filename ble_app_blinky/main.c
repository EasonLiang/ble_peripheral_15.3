...
{
    ret_code_t err_code = app_timer_init();     // Initialize timer module, making it use the scheduler
...
{   //Function for initializing services that will be used by the application.
    ...
    init.led_write_handler = led_write_handler;             // Initialize LBS.
 ...
 * @details This function will be called for all events in the Connection Parameters Module that are passed to the application.
 * @note All this function does is to disconnect. This could have been done by simply setting the disconnect_on_fail config 
